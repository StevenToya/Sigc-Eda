...
?>
<h2>LISTA DE VEHICULOS PARA AUDITAR</h2>
			...
			<table class="table table-striped table-bordered table-hover" id="dataTables-example">
				...
				?>
					<tr class="odd gradeX">
										...
										?>
												...
												<?php }else{ ?>
													<?php if($row_doc["fecha_vencimiento"]){ ?>
															...
															<?php
															if($row_doc["fase"]=='1'){$fs = '<b><font color=red>(E)</font></b>';}
															if($row_doc["fase"]=='2'){$fs = '<b><font color=green>(A)</font></b>';}
															if($row_doc["fase"]=='3'){$fs = '<b><font color=#DF7401>(R)</font></b>';}
													...
													<?php }else{ ?>
															<?php
																...
																if(!$row_doc["fecha_expedicion"])
																{$row_doc["fecha_expedicion"] = "Descargar";}
															?>
															<td align="center">
																<a href="<?php echo $row_doc["archivo"]; ?>"  target="_blank">
						...
						<td  align='center'><a href="?cmp=auditar_documento&idvehiculo=<?php echo $row["id"] ?>"><i class="fa fa-pencil-square-o fa-2x"></i> </a></td></td>
...
<table>
	<tr>
		<td><b><font color=red>(E) </font></b> </td>
	...
	<tr>
		<td><b><font color=#DF7401>(R) </font></b> </td>
