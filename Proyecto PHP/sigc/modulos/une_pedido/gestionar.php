...
<h2>ESTADO DE LOS PEDIDOS SIN FINALIZAR <b>HFC</b></h2>
...
<table width="100%">
	<tr>
		<td>
			...
			?>
			<a href="modulos/une_pedido/lista_pendiente.php?excel=1&mm=<?php echo $mm ?>&aa=<?php echo $ano_ges	 ?>" target=blank>
			...
			?>
				<a href="modulos/une_pedido/lista_pendiente.php?excel=1&mm=<?php echo $mm ?>&aa=<?php echo $ano_ges	?>&ee=<?php echo $row_cont["estado_material"] ?>" target=blank>
					<button class="btn btn-primary" type="button">
		...
		<td align=right>
			<a href="modulos/une_pedido/lista_pendiente.php?excel=1&mm=<?php echo $mm ?>&aa=<?php echo $ano_ges	 ?>" target=blank> <i class="fa fa-cloud-download fa-2x"></i> Descargar excel </a>		
		<td>
	</tr>
</table>
...
<div class="panel panel-default" style="width:100%;">
   <div align=left class="panel-heading">Pedidos sin confirmar </div>
