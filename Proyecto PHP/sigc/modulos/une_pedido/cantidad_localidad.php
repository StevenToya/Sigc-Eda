			...
			<div class="panel panel-default" style="width:100%;">
			 ...
			 <table align=center width=50% class="table">
			   ...
			   $sql_pedido = "SELECT ciudad, tipo_trabajo,  producto_homologado, COUNT(*) AS cantidad FROM  une_pedido 
								WHERE fecha >= '".$ano_ges."-".$mm."-01' AND fecha <= '".$ano_ges."-".$mm."-31' AND une_pedido.tipo='1'
			   ...
			   <tr>
				...
				{	
					$total_pedido = $row_total["cantidad"];
								   ...
								   FROM  une_pedido 
													WHERE fecha >= '".$ano_ges."-".$mm."-01' AND fecha <= '".$ano_ges."-".$mm."-31' AND ciudad = '".$row_total["ciudad"]."' AND une_pedido.tipo='1'
													AND une_pedido.ciudad IN ('Monteria','Sincelejo','Valledupar')
