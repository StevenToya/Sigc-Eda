...
while($row = mysql_fetch_array($res))
{
	...
	if($_POST[$material_tem])
	{
		...
		`id_usuario_revisa_material` = '".$_SESSION["user_id"]."', 
		`contratista_material` ='".$_POST[$material_tem]."',  
		`observacion_contratista_material` = '".$_POST[$observacion_tem]."'
		...
		observacion_edatel, observacion_edatel_material, observacion_edatel_equipo
			...
			while($row = mysql_fetch_array($res))
			{
				...
				<tr>
					...
					<td><?php echo $row["observacion_edatel_material"]; ?></td>					
				...
				<!--
					...
					<td align=center><textarea name="obs_<?php echo $row["id"] ?>" ><?php echo $row["observacion_contratista_material"] ?></textarea> </td>
