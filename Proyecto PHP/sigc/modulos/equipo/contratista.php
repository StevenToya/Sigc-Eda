<?php  
if($PERMISOS_GC["liq_equ_cont"]!='Si'){   
...
<h2>TRAMITES PARA REVISION EIA <b>( EQUIPOS )</b> </h2>
...
<table width=100%>
	<tr>
				...
				<div class="row" >
				   <div class="col-lg-6" style="width:70%" >
					<div class="input-group" >
					  <input type="text" class="form-control"   name="ot" placeholder=" Buscar OT..." required>
		...
		<td width=30%>	
			<form action="?cmp=buscar_serial_contratista"  method="post" name="form" id="form"  enctype="multipart/form-data">
				<div class="row">
				   <div class="col-lg-6" style="width:70%">
					<div class="input-group">
					  <input type="text" class="form-control" name="serial" placeholder="Buscar Serial...">
					  <span class="input-group-btn">
						<button class="btn btn-primary"  type="submit">Buscar</button>
					  </span>
					</div>
		...
		<td align=right> 
			<a href="modulos/equipo/panel_equipo.php?excel2=1" target=blank> <i class="fa fa-cloud-download fa-2x"></i> Exportar equipos libres</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
		<td align=right>
			<a href="modulos/liquidacion/excel_contratista.php?tip=10" target="blank"><i class="fa fa-cloud-download fa-2x"></i> Exportar tramites mes </a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		
		</td>
	</tr>
</table>
		...
		<div class="panel-body">
			<table  class="table table-striped table-bordered table-hover" align=center width=100%>
				...
				<?php
					...
					SUM(IF(tramite.contratista_equipo=1,1,0)) AS omitido,
					SUM(IF(tramite.contratista_equipo=2,1,0)) AS confirmado,
					SUM(IF(tramite.contratista_equipo=3,1,0)) AS rechazado,
					SUM(IF(tramite.contratista_equipo=4,1,0)) AS volver,					
					id_tipo_trabajo,
