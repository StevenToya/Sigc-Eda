...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
$sql_cont = "SELECT COUNT(*) AS cantidad FROM stohome_plataforma";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
$sql_cont = "SELECT COUNT(*) AS cantidad FROM stohome_sap";
$res_cont = mysql_query($sql_cont);
$row_cont = mysql_fetch_array($res_cont);
?>
<a href="?cmp=sap">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
$sql_cont = "SELECT COUNT(*) AS cantidad FROM stohome_car";
$res_cont = mysql_query($sql_cont);
$row_cont = mysql_fetch_array($res_cont);
?>
<a href="?cmp=car">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
$sql_cont = "SELECT COUNT(*) AS cantidad FROM stohome_rubro";
$res_cont = mysql_query($sql_cont);
$row_cont = mysql_fetch_array($res_cont);
?>
<a href="?cmp=rubro">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
$sql_cont = "SELECT COUNT(*) AS cantidad FROM stohome_item WHERE tipo=1 ";
$res_cont = mysql_query($sql_cont);
$row_cont = mysql_fetch_array($res_cont);
?>
<a href="?cmp=rol">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
$sql_cont = "SELECT COUNT(*) AS cantidad FROM stohome_item WHERE tipo=2 ";
$res_cont = mysql_query($sql_cont);
$row_cont = mysql_fetch_array($res_cont);
?>
<a href="?cmp=item">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
$sql_cont = "SELECT COUNT(*) AS cantidad FROM stohome_persona WHERE estado = 1";
$res_cont = mysql_query($sql_cont);
$row_cont = mysql_fetch_array($res_cont);
?>
<a href="?cmp=persona">
