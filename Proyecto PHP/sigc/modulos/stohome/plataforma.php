...
if($_GET["eliminar"])
{
	$sql = "DELETE FROM `stohome_plataforma` WHERE `id` = '".$_GET["eliminar"]."' LIMIT 1;";
	mysql_query($sql);		
}
...
{	
	...
	$sql = "INSERT INTO `stohome_plataforma` (nombre, fecha_registro)
	...
	<div class="panel-body" >
		<div class="table-responsive" >
			...
			<table class="table table-striped table-bordered table-hover" id="dataTables-example">
				...
				<tbody>
				<?php
				$sql = "SELECT * FROM stohome_plataforma ORDER BY nombre ASC";
				$res = mysql_query($sql);
				...
				?>
					<tr class="odd gradeX">
						...
						<?php
						$sql_bb = "SELECT id FROM stohome_persona WHERE id_plataforma = '".$row["id"]."' LIMIT 1 ";
