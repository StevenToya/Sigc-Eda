<?php
if($PERMISOS_GC["une_dth_cons"]!='Si')
{ 
...
<div class="panel panel-default" style="width:100%;">
   <div align=left class="panel-heading">Tramites DTH ingresados</div>
   ...
   {			
	?>
		<tr>
			...
			<td><?php echo $row_pedido["nom_usuario"] ?> <?php echo $row_pedido["ape_usuario"] ?> </td>
			<td><?php echo $row_pedido["fecha_registro"] ?></td>				
			<td align=center><a href="?cmp=detalle_consultor&id=<?php echo $row_pedido["id"] ?>"> <font <?php echo $font ?> ><i class="fa fa-eye fa-2x"> </i></font> </a></td></td>
	   </tr>
		   <?php 
   }     
?>
