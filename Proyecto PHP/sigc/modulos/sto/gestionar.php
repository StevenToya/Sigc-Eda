...
{	
	...
	$sql_del = "DELETE FROM `sto_ejecutado` WHERE `id_periodo` = '".$row_per["id"]."' AND id_item = '".$_GET["idi"]."'  AND id_persona = '".$_GET["idp"]."'  ";
	mysql_query($sql_del);
	
	$sql_del = "DELETE FROM `sto_no_ejecutado` WHERE `id_periodo` = '".$row_per["id"]."' AND id_item = '".$_GET["idi"]."'  AND id_persona = '".$_GET["idp"]."'  ";
	mysql_query($sql_del);
	...
	foreach ($vector AS $k => &$valor) 
	{
		...
		if($_POST[$tem])
		{
			 $sql_g = "INSERT INTO `sto_ejecutado` 
		...
		{
			$sql_g = "INSERT INTO `sto_no_ejecutado` 
						...
						<tr bgcolor="silver">
							...
							{			
								...
								else
								{
									...
									$sql_eje = "SELECT id, observacion FROM sto_ejecutado WHERE id_item = '".$_GET["idi"]."' AND 
