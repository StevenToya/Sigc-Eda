...
if($_GET["eliminar"])
{
	$sql = "DELETE FROM `sto_car` WHERE `id` = '".$_GET["eliminar"]."' LIMIT 1;";
	mysql_query($sql);		
}
	...
	<div class="panel-body" >
		<div class="table-responsive" >
			...
			<table class="table table-striped table-bordered table-hover" id="dataTables-example">
				...
				<tbody>
				<?php
				$sql = "SELECT * FROM sto_car ORDER BY nombre ASC";
				$res = mysql_query($sql);
				...
				?>
					<tr class="odd gradeX">
						...
						<?php
						$sql_bb = "SELECT id FROM sto_persona WHERE id_car = '".$row["id"]."' LIMIT 1 ";
