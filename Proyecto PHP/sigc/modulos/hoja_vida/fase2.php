  ...
  <div class="col-md-100 col-sm-100">
				<div class="panel panel-primary">
					<div class="panel-danger">
                        <div class="panel-heading">
                           <b>Auditar hoja de vida</b>
                        </div>
                        <div class="panel-body">
						<form action="?id=<?php echo $_GET["id"] ?>"  method="post" name="form" id="form"  enctype="multipart/form-data">
							Motivo
                            <textarea class="form-control" rows="3" name="motivo_rechazo" required></textarea><br>
							<select name="estado" required>
								<option value="">Seleccione una opcion</option>
								<option value="5">Aceptar datos basicos</option>
								<option value="6">Rechazar datos basicos</option>
								<option value="8">DESCARTAR Y BLOQUEAR HOJA DE VIDA</option>								
							</select>
							<br>
							<center>
								<input class="btn btn-primary" type="submit" name="guardar" value="Auditar hoja de vida">
							</center>
						</form>
                        </div>
